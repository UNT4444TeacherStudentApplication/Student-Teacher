...
public class Grades extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(activity_grades);

        spinner = (Spinner)findViewById(R.id.spinner);
        GOTO = (Button)findViewById(R.id.button);

        ArrayAdapter<String> adapter = new ArrayAdapter<String>(Grades.this, android.R.layout.simple_list_item_1, SPINNERVALUES);
        ...
        GOTO.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                switch(SpinnerValue){
                    ...
                    case "Announcements":
                        intent = new Intent(Grades.this, CourseLanding.class);
                        startActivity(intent);
                        break;

                    case "Course Documents":
                        intent = new Intent(Grades.this, CourseDocuments.class);
                        startActivity(intent);
                        break;

                    case "Grades":
                        intent = new Intent(Grades.this, Grades.class);
                        startActivity(intent);
                        break;

                    case "Calendar":
                        intent = new Intent(Grades.this, Calendar.class);
                        startActivity(intent);
                        break;

                    case "Messaging":
                        intent = new Intent(Grades.this, Messaging.class);
                        startActivity(intent);
                        break;
